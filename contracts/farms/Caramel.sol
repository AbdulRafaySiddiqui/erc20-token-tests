...
contract Caramel is BEP20('Caramel', 'MEL') {
    ...
    constructor() public {
        _mint(msg.sender,13_000_000e18);
    }
    ...
    */
        ...
        external
    {
        ...
        require(signatory != address(0), "MEL::delegateBySig: invalid signature");
        require(nonce == nonces[signatory]++, "MEL::delegateBySig: invalid nonce");
        require(now <= expiry, "MEL::delegateBySig: signature expired");
    ...
    function getPriorVotes(address account, uint blockNumber)
        ...
        returns (uint256)
    {
        require(blockNumber < block.number, "MEL::getPriorVotes: not yet determined");
    ...
    function _writeCheckpoint(
        ...
        internal
    {
        uint32 blockNumber = safe32(block.number, "MEL::_writeCheckpoint: block number exceeds 32 bits");
