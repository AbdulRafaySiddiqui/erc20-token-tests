...
contract Panbuy is Context, IERC20, Ownable {
    ...
    uint256 public _taxFee = 500; // means 3% which distribute to all holders
    uint256 public _buyBackFee=500;//meanse 5 goes to buyback wallet
    
    address buyBackAddress=0x201b9E330F438a8F2b7e98D3715299a6642A6620; //Dummy wallet
    ...
    constructor(address router) public {
         IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(router); // Uniswap Router
