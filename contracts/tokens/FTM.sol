...
contract FTM is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    function calculateFee(uint256 feeIndex, uint256 amount) internal returns(uint256, uint256) {
        ...
        return (taxFee, marketingFee.add(liqFee));
    }
    ...
    function swap() private lockTheSwap {
        uint256 totalFee = _liqFeeCollected.add(_marketingFeeCollected);
        ...
        emit Swap(totalFee, amountToSwap);
    }
