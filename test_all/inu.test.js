...
describe('IslandInu Test', () => {
    ...
    it('It should deploy exchange and token', async () => {
        ...
        const tokenContract = await ethers.getContractFactory('IslandInu')
        token = await tokenContract.deploy(router.address, deployer.address, '0xc499a2E63d38dE517789037e25D69e4Fbbc55eF3', '0x4d50DA60fE164904074A78C82F6024548342b1dC')
    })
