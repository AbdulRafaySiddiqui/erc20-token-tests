...
describe('MiniSportZilla Test', () => {
    ...
    it('It should deploy exchange and token', async () => {
        [deployer, feeTo, user1, user2, marketing, development] = await ethers.getSigners()
        ...
        token = await tokenContract.deploy(router.address, deployer.address, marketing.address, development.address, ZERO_ADDRESS, cake.address)
    })

    it('It should Add MiniSportZilla liquidity', async () => {
